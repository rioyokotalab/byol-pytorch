...
log_root="$git_root/results_root/result/pretrain/pytorch/20220423_215528"

# resume_root="$git_root/results_root/result/pretrain/pytorch/20220423_215528/resume"
resume_root="$git_root/results_root/result/pretrain/pytorch/20220424_000039/resume"
last_resume_name=$(find "$resume_root" -type f | sort | tail -1)
resume_path="$last_resume_name"

date_str=$(date '+%Y%m%d_%H%M%S')
result_root="$log_root/continue_root/$date_str"
