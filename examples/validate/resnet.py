...
def calc_padding_same(in_height, in_width, strides, filter_height,
                      filter_width):
...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.fc = nn.Linear(width_multiplier * 512 * block.expansion,
                            num_classes)
...
def resnet200(pretrained=False, progress=True, **kwargs):
    ...
    return _resnet('resnet200', Bottleneck, [3, 24, 36, 3], pretrained,
                   progress, **kwargs)
